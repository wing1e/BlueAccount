...
const globalStyle = {
  ...
  navigationBarBackgroundColor: "#003498",
...
const S = true, b = "mp-weixin", T = I(define_process_env_UNI_SECURE_NETWORK_CONFIG_default), A = b, P = I('{"address":["127.0.0.1","192.168.1.17"],"servePort":7000,"debugPort":9000,"initialLaunchType":"local","skipFiles":["<node_internals>/**","D:/Development/HBuilderX/plugins/unicloud/**/*.js"]}'), C = I('[{"provider":"alipay","spaceName":"bluenote-cloud","spaceId":"env-00jxtfjq2ym4","spaceAppId":"2021005142636583","accessKey":"WFgOnwaNnRL7Ve8b","secretKey":"P3NawdszUZHnHjFQ"}]') || [];
let O = "";
try {
  O = "__UNI__20496D5";
} catch (e2) {
